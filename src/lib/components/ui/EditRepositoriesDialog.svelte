...
<Dialog.Root bind:open>
	<Dialog.Portal>
		...
		<Dialog.Content
			class="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-background border border-border/30 rounded-lg shadow-xl z-50 w-full max-w-2xl max-h-[80vh] flex flex-col"
		>
			...
			<div class="flex justify-end gap-3 p-6 border-t border-border/10">
				<Dialog.Close
					class="px-4 py-2 border border-border/30 rounded-md hover:bg-muted transition-colors"
				>
					Cancel
				</Dialog.Close>
				<button
