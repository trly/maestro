		...
		{:else}
			<div class="space-y-6">
					...
					<div class="space-y-6">
						<div>
							...
							<p class="text-xs text-muted-foreground mb-2">
								Required for executing prompts with Amp
							</p>
							...
							<p class="text-xs text-muted-foreground mt-2">
								Get your token at <a
									...
									target="_blank"
									class="underline">ampcode.com/settings</a
								>
							</p>
						</div>
						...
						<div>
							...
							<p class="text-xs text-muted-foreground mt-2">
								Generate at <a
									...
									target="_blank"
									class="underline">github.com/settings/tokens</a
								>
				...
				<div class="p-6 border rounded-lg bg-card">
					...
					<div class="space-y-6">
						<div>
							<label for="sourcegraph-endpoint" class="block text-sm font-medium mb-2"
								>Sourcegraph Instance</label
							>
						...
						<div>
							<label for="sourcegraph-token" class="block text-sm font-medium mb-2"
								>Sourcegraph Access Token</label
							>
							<p class="text-xs text-muted-foreground mb-2">
								Required for repository search API access
							</p>
							<div class="flex flex-col sm:flex-row gap-2">
				...
				<div class="p-6 border rounded-lg bg-card">
					...
					<div class="space-y-6">
						<!-- Editor Selection -->
						<div>
							<label for="editor-select" class="block text-sm font-medium mb-2"
							...
							{#if availableEditors.length > 0}
								...
								>
									...
									>
										<span
											>{availableEditors.find((e) => e.command === selectedEditorValue)
												?.displayName || "Select an editor"}</span
										>
				...
				<div class="p-6 border rounded-lg bg-card">
					...
					<div class="space-y-6">
						<div>
							<label for="ci-threshold-input" class="block text-sm font-medium mb-2"
								>CI Stuck Timeout</label
							>
							<p class="text-xs text-muted-foreground mb-2">
						...
						<div>
							...
							<p class="text-xs text-muted-foreground mt-2">
								Default: 10 executions. Increase for faster bulk operations, decrease to limit
								resource usage.
							</p>
						</div>
					</div>
					...
					<div>
						...
						<div class="flex gap-3">
							<button
								...
								class="flex-1 px-4 py-3 border rounded-md transition-colors {currentTheme ===
								'light'
