...
<div class="flex flex-col min-h-0 overflow-hidden">
	...
	>
		...
		<button
			...
			class="flex-shrink-0 w-5 h-5 flex items-center justify-center rounded border-2 
			       {allVisibleSelected ? 'border-primary bg-primary' : someVisibleSelected ? 'border-primary bg-primary/50' : 'border-muted-foreground/30 hover:border-primary/50'} 
			       transition-colors"
	...
	<div class="flex items-center gap-1.5">
		...
		<div class="text-xs font-semibold text-muted-foreground text-right">
			Actions
		</div>
	</div>
