...
pub(crate) fn emit_execution_session(
    app: &tauri::AppHandle,
    execution_id: &str,
    session_id: &str,
    thread_url: &str,
...
pub(crate) fn emit_execution_validation(
    app: &tauri::AppHandle,
    execution_id: &str,
    validation_status: &str,
    validation_thread_url: Option<&str>,
) {
...
pub(crate) fn emit_execution_commit(
    app: &tauri::AppHandle,
    execution_id: &str,
    commit_status: &str,
...
pub(crate) fn emit_execution_ci(
    app: &tauri::AppHandle,
    execution_id: &str,
    ci_status: &str,
    ci_url: Option<&str>,
...
pub(crate) fn emit_analysis_status(
    app: &tauri::AppHandle,
    analysis_id: &str,
    status: &str,
